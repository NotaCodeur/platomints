...
const TokenSwiperSection = ({ state, dispatch, stateTwo, dispatchTwo }) => {
    ...
    return (
        <>
            <div ref={art} className='artSection' style={{ width: '100%', }}>
                            ...
                            >
                                {stateTwo?.userNFTArray?.map((NFT, index) => (
                                    ...
                                    <SwiperSlide
                                        ...
                                        <TokenCard NFT={NFT} artSize={artSize} stateTwo={stateTwo} dispatchTwo={dispatchTwo}  />
                                        {/* <Card
...
export default TokenSwiperSection