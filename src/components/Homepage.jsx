...
import NFTSwiperSection from './sections/NFTSwiperSection';
import TokenSwiperSection from './sections/TokenSwiperSection';
          ...
          <Row className='navDiv' align="middle">
            ...
            <Row className='placeholder'>
              ...
              <Col xs={12} sm={12} md={12} lg={12} xl={12} align='center' style={{ marginTop: 20, padding: 0, }}>
                ...
                <br />
                {/* <Row align='center'>
                  {stateTwo?.userNFTArray.map((NFT, index) => {
              ...
              <Col xs={22} sm={22} md={20} lg={14} xl={14} align='center'>
                ...
                {GameData.map((game, index) => <PlayToMintCard key={index} gameObj={game}></PlayToMintCard>)}
            ...
            <Row justify='center' align='center'>
              ...
              <h3 className='siteTitle' style={{ marginLeft: 10 }}>NFT's </h3>
            </Row >
            <NFTSwiperSection state={state} dispatch={dispatch} stateTwo={stateTwo} dispatchTwo={dispatchTwo} />

            <Row justify='center' align='center'>
              <h3 className='siteTitle' style={{ marginLeft: 0 }}>👇 </h3>
              <h3 className='siteText' style={{ marginLeft: 10, fontSize: 32 }}>Your </h3>
              <h3 className='siteTitle' style={{ marginLeft: 10 }}>Tokens </h3>
            </Row >
